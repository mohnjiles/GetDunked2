...
public class QPopup extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		switch (position) {
		case 0:
			SetStuff("Dark Flight", R.drawable.dark_flight, "Range",
					"Cooldown", "Cost", "Physical Damage", "650",
					"16 / 15 / 14 / 13 / 12 seconds", "10% of Current Health",
					"70 / 115 / 160 / 205 / 250 (+ 60% bonus AD)");
			break;
		case 1:
			SetStuff("Orb of Deception", R.drawable.orb_of_deception, "Range",
					"Cooldown", "Cost", "Magic / True Damage",
					"Max Damage to Same Target", "880", "7 seconds",
					"70 / 75 / 80 / 85 / 90 Mana",
					"40 / 65 / 90 / 115 / 140 (+ 33% AP)",
					"80 / 130 / 180 / 230 / 280 (+ 66% AP)");
			break;
		case 2:
			SetStuff("Mark of the Assassin", R.drawable.mark_of_the_assassin,
					"Range", "Cooldown", "Cost", "Initial Magic Damage",
					"Detonation Magic Damage", "Energy Restored", "600",
					"6 / 5.5 / 5 / 4.5 / 4 seconds", "60 Energy",
					"35 / 55 / 75 / 95 / 115 (+ 40% AP)",
					"45 / 70 / 95 / 120 / 145 (+ 50% AP)",
					"20 / 25 / 30 / 35 / 40 Energy");
			break;
		case 3:
			SetStuff("Pulverize", R.drawable.pulverize, "Range", "Cooldown",
					"Cost", "Magic Damage", "182.5",
					"17 / 16 / 15 / 14 / 13 seconds",
					"70 / 80 / 90 / 100 / 110 Mana",
					"60 / 105 / 150 / 195 / 240 (+50% AP)");
			break;
		case 4:
			SetStuff("Bandage Toss", R.drawable.bandage_toss, "Range",
					"Cooldown", "Cost", "Magic Damage", "1100",
					"16 / 14 / 12 / 10 / 8 seconds",
					"80 / 90 / 100 / 110 / 120 Mana",
					"80 / 130 / 180 / 230 / 280 (+ 70% AP)");
			break;
		case 5:
			SetStuff("Flash Frost", R.drawable.flash_frost, "Range",
					"Projectile Speed", "Cooldown", "Cost", "Magic Damage",
					"Max Damage", "1100", "850",
			...
			break;
		case 6:
			SetStuff("Disintegrate", R.drawable.disintegrate, "Range",
					"Cooldown", "Cost", "Magic Damage", "625", "4 seconds",
					"60 / 65 / 70 / 75 / 80 Mana",
					"85 / 125 / 165 / 205 / 245 (+ 70% AP)");
			break;
		case 7:
			SetStuff("Frost Shot", R.drawable.frost_shot, "Cost", "Slow",
					"8 Mana per Attack", "15 / 20 / 25 / 30 / 35%");
			break;
		case 8:
			SetStuff("Rocket Grab", R.drawable.rocket_grab, "Range",
					"Cooldown", "Cost", "Magic Damage", "Projectile Speed",
					"925", "20 / 19 / 18 / 17 / 16 seconds", "120 Mana",
					"80 / 135 / 190 / 245 / 300 (+ 100% AP)", "1800");
			break;
		case 9:
			SetStuff("Sear", R.drawable.sear, "Range", "Cooldown", "Cost",
					"Magic Damage", "900", "8 / 7.5 / 7 / 6.5 / 6 seconds",
					"50 Mana", "80 / 120 / 160 / 200 / 240 (+ 65% AP)");
			break;
		case 10:
			SetStuff("Piltover Peacemaker", R.drawable.piltover_peacemaker,
					"Range", "Cooldown", "Cost", "Physical Damage",
					"Minimum Damage", "1300", "10 / 9 / 8 / 7 / 6 seconds",
					"50 / 60 / 70 / 80 / 90 mana",
					"20 / 60 / 100 / 140 / 180 (+ 130% AD)",
					"10 / 30 / 50 / 70 / 90 (+ 65% AD)");
			break;
		case 11:
			SetStuff("Noxious Blast", R.drawable.noxious_blast, "Range",
					"Cooldown", "Cost", "Magic Damage per Second",
					"Total Magic Damage", "Movement Speed", "850", "3 seconds",
					"35 / 45 / 55 / 65 / 75 Mana",
					"25 / 38 / 52 / 65 / 78 (+ 27% AP)",
					"75 / 115 / 155 / 195 / 235 (+ 80% AP)",
					"15% / 17.5% / 20% / 22.5% / 25%");
			break;
		case 12:
			SetStuff("Rupture", R.drawable.rupture, "Range", "Cooldown",
					"Cost", "Magic Damage", "950", "9 seconds", "90 Mana",
					"80 / 135 / 190 / 245 / 305 (+ 100% AP)");
			break;
		case 13:
			SetStuff("Phosphorus Bomb", R.drawable.phosphorus_bomb, "Range",
					"Cooldown", "Cost", "Magic Damage", "600", "8 seconds",
					"80 / 90 / 100 / 110 / 120 Mana",
					"80 / 130 / 180 / 230 / 280 (+ 50% AP)");
			break;
		case 14:
			SetStuff("Decimate", R.drawable.decimate, "Range", "Cooldown",
					"Cost", "Shaft Physical Damage", "Blade Physical Damage",
					"425", "9 / 8 / 7 / 6 / 5 seconds", "40 Mana",
					"70 / 105 / 140 / 175 / 210 (+ 70% bonus AD)",
					"105 / 157.5 / 210 / 262.5 / 315 (+ 105% bonus AD)");
			break;
		case 15:
			SetStuff("Crescent Strike", R.drawable.crescent_strike, "Range",
					"Cooldown", "Cost", "Magic Damage", "830",

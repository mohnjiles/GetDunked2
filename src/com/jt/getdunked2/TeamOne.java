...
public class TeamOne{
   	...
   	private Number timeAddedToQueue;
	...
	public void setOriginalPlatformId(String originalPlatformId){
 	...
 	public Number getPickMode(){
		return this.pickMode;
	}
	public void setPickMode(Number pickMode){
	...
	public void setTeamOwner(boolean teamOwner){
 	...
 	public Number getTimeAddedToQueue(){
		return this.timeAddedToQueue;
	}
	public void setTimeAddedToQueue(Number timeAddedToQueue){

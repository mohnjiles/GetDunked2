...
public class AbilityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
  	  ...
  	  switch (position) {
  		case 0:
  			setImages(R.drawable.blood_well, R.drawable.dark_flight, R.drawable.blood_thirst, R.drawable.blades_of_torment, R.drawable.massacre);
  			setTitles("Blood Well", "Dark Flight", "Blood Thirst / Blood Price", "Blades of Torment", "Massacre");
  			setText(R.string.BloodWell, R.string.DarkFlight, R.string.BloodThirst, R.string.BladesofTorment, R.string.Massacre);
  			return V;
  		case 2:
  		...
  		case 26:
  			...
  			return V;
  		case 27:
  			setImages(R.drawable.happy_hour, R.drawable.barrel_roll, R.drawable.drunken_rage, R.drawable.body_slam, R.drawable.explosive_cask);
    ...
    private void setImages(int passiveIcon, int qIcon, int wIcon, int eIcon, int rIcon) {
    ...
    private void setTitles(String passiveTitle, String qTitle, String wTitle, String eTitle, String rTitle) {
    ...
    private void setText(int passiveText, int qText, int wText, int eText, int rText){
